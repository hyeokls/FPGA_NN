...
HD_PWD='/home/lsh/2025/vivado_zynq_proj_scw60p79/finn_zynq_link.runs/top_axi_perf_mon_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_axi_perf_mon_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_axi_perf_mon_0_0.tcl
